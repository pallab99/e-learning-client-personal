...
import { Badge, Button, Descriptions, Modal, Upload, message } from "antd";
        ...
        <>
          <ButtonAtom
            ...
            handleButtonClick={() => {
              ...
              setAssignmentFile(assignmentData?.data?.assignmentFileURL);
            }}
          ...
          >
            <div className="assignment_iframe_div mt-40">
              <iframe src={assignmentFile} height={450} width={"100%"}></iframe>
            </div>
          </Modal>
        </>
      ),
