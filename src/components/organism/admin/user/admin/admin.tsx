...
const AllAdminTableOrganism: React.FC<AllAdminOrganismProps> = ({ data }) => {
  ...
  return (
    <div className="all-student-table-div mt-50">
      <Card>
        <HeadingAtom text="All admin list" level={1} className="mb-30" />
        <Table
          columns={columns}
          dataSource={data}
          scroll={{ x: 1300 }}
...
export default AllAdminTableOrganism;
